...
class MCSL(BaseLearner):
    ...
    def learn(self, data, columns=None, **kwargs):
        ...
        self.weight_causal_matrix = Tensor(causal_matrix_weight, index=X.columns,
                                           columns=X.columns)
    ...
    def _mcsl(self, X, pns_mask):
        ...
        W_est, W_est_weight = callback_after_training(W_logits, self.temperature, self.graph_thres)

        return W_est, W_est_weight
